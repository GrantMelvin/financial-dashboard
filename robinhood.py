...
# Get your current positions (stocks you own)
positions = r.account.build_holdings()

# Print portfolio value
print(f"Portfolio Value: ${portfolio['equity']}")
...
#     print(f"{stock}: {data['quantity']} shares, Current Price: {data['price']}, Total Value: {data['equity_value']}")
